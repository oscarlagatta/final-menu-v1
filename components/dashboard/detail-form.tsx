...
import { type MetricModel, useMetricsData, useUsersData } from "@bofa/data-services"
...
import { calculationTypes, formatDate, STATUS, statuses, valueTypes } from "@bofa/util"
...
export function MetricDetailForm() {
    ...
    const [calculationTypePopOverOpen, setCalculationTypePopOverOpen] = useState(false)
    ...
    const [metricAlignmentPopOverOpen, setMetricAlignmentPopOverOpen] = useState(false)
    const [granularityNamePopOverOpen, setGranularityNamePopOverOpen] = useState(false)
    ...
    const [thresholdDirectionTypePopOverOpen, setThresholdDirectionTypePopOverOpen] = useState(false)
    ...
    const initialSearchTerm = initialMetricOwner ? formatInitialMetricOwner(initialMetricOwner) : ""

    const { data: searchUsers = [], isLoading: isSearchLoading } = useUsersData(search || initialSearchTerm) as {
        data: UserModel[]
        isLoading: boolean
    }
    ...
    const users = useMemo(() => {
        if (initialMetricOwnerId) {
            const initialUser = searchUsers?.find((user) => user.nbid === initialMetricOwnerId)
            if (initialUser) {
                return [initialUser, ...searchUsers.filter((user) => user.nbid !== initialMetricOwnerId)]
            }
        }
        return searchUsers
    ...
    useEffect(() => {
        if (initialMetricOwnerId) {
            const initialUser = users.find((user) => user.nbid === initialMetricOwnerId)
            if (initialUser) {
            ...
            toast("Metric Updated Successfully", {
                ...
                description: (
                    <div className="flex items-center">
                        ...
                        <span>
              The metric with name <strong>{formData.metricName}</strong> has been updated.
            </span>
                    </div>
                ),
                duration: 5000,
                ...
                toast("Metric Name already exists", {
                    ...
                    description: (
                        <div className="flex items-center">
                            ...
                            <span>
                A metric with the name <strong>{formData.metricName}</strong> already exists.
              </span>
                        </div>
                    ),
                    duration: 5000,
    ...
    const formatUserSummary = (user: UserModel) => `${user.fullName} - ${user.titleName}`

    return (
        <>
            <QueryLoading isLoading={isLoading || isSubmitting} loadingText="Fetching data" showText={false} />
            <div className="w-full max-w-4xl mx-auto">
                {error ? (
                    <Alert variant="destructive">
                        <AlertCircle className="h-4 w-4" />
                        <AlertTitle>Metric Detail Error</AlertTitle>
                        <AlertDescription>Error connecting to backend service, please reload the page.</AlertDescription>
                    </Alert>
                ) : (
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}>
                            <div className="space-y-10">
                                ...
                                <div className="flex items-center justify-between border-b pb-4">
                                    <h1 className="text-2xl font-semibold text-gray-900">Metric Details</h1>
                                    <Button
                                        type="submit"
                                ...
                                <div className="space-y-10">
                                    ...
                                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                        <h2 className="mb-6 text-lg font-medium text-gray-900 border-b pb-2">Metric Definition</h2>
                                        <div className="space-y-6">
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Metric Name</FormLabel>
                                                        <FormControl>
                                                            <Input
                                            ...
                                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                                                            ...
                                                                            <CommandGroup>
                                                                                {statuses?.map((value) => (
                                                                                    <CommandItem
                                                                                        ...
                                                                                        key={value.value}
                                                                                        onSelect={() => {
                                                                                            form.setValue("status", value.value ?? STATUS.Draft)
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem className="flex flex-col">
                                                            <FormLabel className="text-base">Metric Type</FormLabel>
                                                            <Popover open={metricTypePopOverOpen} onOpenChange={setMetricTypePopOverOpen}>
                                                                <PopoverTrigger asChild>
                                                                    <FormControl>
                                                                        <Button
                                                                            disabled={form.formState.isSubmitting}
                                                                            ...
                                                                            <CommandGroup>
                                                                                {metricTypes?.map((type) => (
                                                                                    <CommandItem
                                                                                        ...
                                                                                        key={type.id}
                                                                                        onSelect={() => {
                                                                                            form.setValue("metricTypeId", type.id)
                                    ...
                                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                        <h2 className="mb-6 text-lg font-medium text-gray-900 border-b pb-2">Source/Contact</h2>
                                        <div className="space-y-6">
                                            <FormField
                                                control={form.control}
                                                name="metricOwnerId"
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Metric Owner</FormLabel>
                                                        <Popover open={metricOwnerOpen} onOpenChange={setMetricOwnerOpen}>
                                                            <PopoverTrigger asChild>
                                                                <FormControl>
                                                                    <Button
                                                                        disabled={form.formState.isSubmitting}
                                                                        ...
                                                                        className={cn("w-full justify-between", !field.value && "text-muted-foreground")}
                                                                    >
                                                                        {selectedUser ? formatUserSummary(selectedUser) : "Select metric owner"}
                                                                        <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                                                    </Button>
                                                                </FormControl>
                                                            </PopoverTrigger>
                                                                            ...
                                                                            {Array.isArray(users) &&
                                                                                users?.map((user: UserModel) => (
                                                                                    <CommandItem
                                                                                        value={user.fullName}
                                                                                        key={user.nbid}
                                                                                        onSelect={() => handleSelect(user.nbid)}
                                                                                    >
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Connection Details</FormLabel>
                                                        <FormControl>
                                                            <Textarea
                                                                disabled={form.formState.isSubmitting}
                                    ...
                                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                        <h2 className="mb-6 text-lg font-medium text-gray-900 border-b pb-2">Metric Thresholds</h2>
                                        <div className="space-y-6">
                                            <FormField
                                                control={form.control}
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Threshold Direction Type</FormLabel>
                                                        <Popover
                                                            open={thresholdDirectionTypePopOverOpen}
                                                            onOpenChange={setThresholdDirectionTypePopOverOpen}
                                                        >
                                                            <PopoverTrigger asChild>
                                                                <FormControl>
                                                                    <Button
                                                                    ...
                                                                    >
                                                                        {field.value
                                                                            ? thresholdDirectionTypes?.find((type) => type.id === field.value)?.name
                                                            ...
                                                            <PopoverContent className="w-[--radix-popover-trigger-width] p-0">
                                                                <Command>
                                                                    <CommandInput placeholder="Search metric type..." />
                                                                    <CommandList>
                                                                        <CommandEmpty>No threshold direction type found.</CommandEmpty>
                                                                        <CommandGroup>
                                                                            {thresholdDirectionTypes?.map((type) => (
                                                                                <CommandItem
                                                                                    value={type.name ?? ""}
                                                                                    key={type.id}
                                                                                    onSelect={() => {
                                                                                        form.setValue("thresholdDirectionTypeId", type.id)
                                                                                        setThresholdDirectionTypePopOverOpen(false)
                                                                                    }}
                                                                                >
                                                                                    <Check
                                                                                        className={cn(
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Value Type</FormLabel>
                                                        <Popover open={valueTypePopOverOpen} onOpenChange={setValueTypePopOverOpen}>
                                                            <PopoverTrigger asChild>
                                                                <FormControl>
                                                                    <Button
                                                                        disabled={form.formState.isSubmitting}
                                                                    ...
                                                                    >
                                                                        {field.value
                                                                            ? valueTypes?.find((type) => type.value === field.value)?.label
                                                                            : "Select value type"}
                                                                        <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                                                    </Button>
                                                                </FormControl>
                                                            ...
                                                            <PopoverContent className="w-[--radix-popover-trigger-width] p-0">
                                                                <Command>
                                                                    <CommandInput placeholder="Search metric type..." />
                                                                    <CommandList>
                                                                        <CommandEmpty>No value types found.</CommandEmpty>
                                                                        <CommandGroup>
                                                                            {valueTypes?.map((value) => (
                                                                                <CommandItem
                                                                                    ...
                                                                                    key={value.value}
                                                                                    onSelect={() => {
                                                                                        form.setValue("valueType", value.value ?? "")
                                                                                ...
                                                                                >
                                                                                    <CheckIcon
                                                                                        className={cn(
                                                                                            "mr-2 h-4 w-4",
                                                                                            value.name === field.value ? "opacity-100" : "opacity-0",
                                                                                        )}
                                                                                    />
                                                                                    {value.label}
                                                                                </CommandItem>
                                            ...
                                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem className="flex flex-col">
                                                            <FormLabel className="text-base">Trigger{valueType === "%" ? " (%) " : ""}</FormLabel>
                                                            <FormControl>
                                                                <Input
                                                                    type="number"
                                                                    {...field}
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem className="flex flex-col">
                                                            <FormLabel className="text-base">Limit{valueType === "%" ? " (%) " : ""}</FormLabel>
                                                            <FormControl>
                                                                <Input
                                                                    type="number"
                                                                    {...field}
                                    ...
                                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                        <h2 className="mb-6 text-lg font-medium text-gray-900 border-b pb-2">Calculation Methodology</h2>
                                        <div className="space-y-6">
                                            <FormField
                                                control={form.control}
                                                name="query"
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Performance Query</FormLabel>
                                                        <FormControl>
                                                            <Textarea
                                                                disabled={form.formState.isSubmitting}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Tables Used By The Query</FormLabel>
                                                        <FormControl>
                                                            <Textarea
                                                                disabled={form.formState.isSubmitting}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Calculation Type</FormLabel>
                                                        <Popover open={calculationTypePopOverOpen} onOpenChange={setCalculationTypePopOverOpen}>
                                                            <PopoverTrigger asChild>
                                                                <FormControl>
                                                                    <Button
                                                                        disabled={form.formState.isSubmitting}
                                                                    ...
                                                                    >
                                                                        {field.value
                                                                            ? calculationTypes?.find((type) => type.value === field.value)?.label
                                                                        ...
                                                                        <CommandGroup>
                                                                            {calculationTypes?.map((value) => (
                                                                                <CommandItem
                                                                                    ...
                                                                                    key={value.value}
                                                                                    onSelect={() => {
                                                                                        form.setValue("metricCalculationType", value.label ?? "")
                                                                                        setCalculationTypePopOverOpen(false)
                                                                                    }}
                                                                                >
                                                                                    <CheckIcon
                                                                                        className={cn(
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Metric Calculation</FormLabel>
                                                        <FormControl>
                                                            <Textarea
                                                                disabled={form.formState.isSubmitting}
                                    ...
                                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                        <h2 className="mb-6 text-lg font-medium text-gray-900 border-b pb-2">Metric Settings</h2>
                                        <div className="space-y-6">
                                            <FormField
                                                control={form.control}
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-col">
                                                        <FormLabel className="text-base">Metric Alignment</FormLabel>
                                                        <Popover open={metricAlignmentPopOverOpen} onOpenChange={setMetricAlignmentPopOverOpen}>
                                                            <PopoverTrigger asChild>
                                                                <FormControl>
                                                                    <Button
                                                                        disabled={form.formState.isSubmitting}

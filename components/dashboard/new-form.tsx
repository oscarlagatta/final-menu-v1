...
export function MetricDetailForm() {
  ...
  return (
    <>
      <QueryLoading isLoading={isLoading || isSubmitting} loadingText="Fetchin data" showText={false} />
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                      ...
                      <div className="space-y-4">
                        ...
                        />
                        {/* Add spacer div for better balance */}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="flex flex-col">
                                <FormLabel>Trigger{valueType === "%" ? " (%) " : ""}</FormLabel>
                                <FormControl>
                                  <Input
                                    type="number"
                                    {...field}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="flex flex-col">
                                <FormLabel>Limit{valueType === "%" ? " (%) " : ""}</FormLabel>
                                <FormControl>
                                  <Input
                                    type="number"
                                    {...field}
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                      <h2 className="mb-4 text-lg font-medium text-gray-900 border-b pb-2">Calculation Settings</h2>
                      <div className="space-y-4">
                        <FormField
                          control={form.control}
                    ...
                    {/* Scheduling Section */}
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                      <h2 className="mb-4 text-lg font-medium text-gray-900 border-b pb-2">Scheduling & Alignment</h2>
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                          <FormField
                            control={form.control}
                                ...
                                <Popover open={metricAlignmentPopOverOpen} onOpenChange={setMetricAlignmentPopOverOpen}>
                                  <PopoverTrigger asChild>
                                    <FormControl>
                                      ...
                                      >
                                        {field.value
                                          ? metricAlignmentIdentifiers?.find((service) => service.id === field.value)
                                              ?.name
                                          : "Select alignment"}
                                        <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                      </Button>

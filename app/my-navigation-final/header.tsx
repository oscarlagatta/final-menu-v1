...
export function Header({ activeItem, activeSubItem, onSubItemClick }: HeaderNavigationProps) {
    ...
    // Remove this redundant breadcrumb code
    // const breadcrumbs = [
        ...
        <TooltipProvider>
            <header className="bg-background sticky top-0 z-10 h-[65px] border-b bg-white shadow-xl">
                <div className="flex flex-wrap items-center gap02 px-4 py-2 sm:px-6">
                    ...
                    <h1 className="resource-hub-title mr-auto text-sm font-semibold">{activeItem && `${activeItem.title}`}</h1>
                                ...
                                return (
                                    <Button
                                        ...
                                        className={cn(
                                            ...
                                            activeSubItem?.id === subItem.id ? "bg-blue-900 text-white" : "text-gray-700 hover:text-gray-900",
                                        )}
                                    >
                                        {subItem.icon && (
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button variant="outline" size="icon" className="help-button hidden sm:flex">

...
export function HeaderNavigation({
    ...
    const breadcrumbs = [
        ...
        { id: activeItem.id, title: activeItem.title, href: `/portal/${activeItem.id}` },
    ]
    ...
    if (activeSubItem) {
        breadcrumbs.push({
            ...
            href: `/portal/${activeItem.id}/${activeSubItem.id}`,
        })
    }

    if (activeNestedItem) {
        breadcrumbs.push({
            id: activeNestedItem.id,
            title: activeNestedItem.title,
            href: `/portal/${activeItem.id}/${activeNestedItem.id}`,
        })
    }
                                    ...
                                    <DropdownMenuContent align="start">
                                        {subItem.subItems.map((nestedItem: any) => (
                                            <DropdownMenuItem
                                                ...
                                                className={activeNestedItem?.id === nestedItem.id ? "bg-accent text-accent-foreground" : ""}
                                            >
